...
A log-normal family distribution is used here for the likelihood, given evidence that speech durations tend to be log-normally distributed [@rosen2005; @ratnikova2017; @gahl2019].
The calculated estimates will then be ratios of vowel duration (for example, an estimate of 1.5 means that vowels are 1.5 times longer when the following consonant is voiced).
...
marginal_ln_post %>%
  ...
  labs(
    ...
    x = "Difference in vowel duration (odds)",
...
estimated_ln_tbl %>%
  ...
  labs(
    ...
    y = "Difference in vowel duration (odds)",
    x = "Study",
...
```{r funnel-sd, include=TRUE, fig.cap = "By-study funnel plot showing the estimate against the standard deviation. The vertical thick and dashed lines are the meta-analytical means of the effect in final and penultimate position."}
